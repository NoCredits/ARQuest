...
function createHeros(){
    ...
    heroes.push(new Warrior('{"race":"gnome","hitpoints":110,"name":"Conan","imgX":6,"imgY":0,"posX":6,"posY":8}'));

    heroes.push(new Druid('{"race":"dwarf","hitpoints":110,"name":"Micha","imgX":9,"imgY":4,"posX":2,"posY":8}'));
